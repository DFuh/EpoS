...
def clc_pwr_vls(obj, bsc_par, par_dct):
    ...
    ### power BoP
    pv.P_gt_max = 0 # on plant level
    pv.P_clnt_max = 0 # on Stack level
    pv.P_ely_max = 0
    pv.P_heat_max = 0
    pv.P_rect_st = 0
    pv.P_tcond_max = minnz([pv.P_clnt_max, pv.P_heat_max])
    pv.ov_P_plnt_DC = (pv.ov_P_stack_N + pv.P_rect_st)* pv.n_st
    pv.ov_P_plnt_AC = pv.ov_P_plnt_DC +pv.P_gt_max +(pv.P_clnt_max + pv.P_ely_max + pv.P_tcond_max)* pv.n_st
    ...
    par_dct['plant']['power_of_plant_AC']['value']    = pv.ov_P_plnt_AC
    par_dct['plant']['power_of_plant_DC']['value']    = pv.ov_P_plnt_DC
